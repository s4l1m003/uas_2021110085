                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="type" name="type">
                                ...
                                <option value="headset" {{ $data->type === 'Headset' ? 'selected' : '' }}>Headset</option>
                                <option value="mouse" {{ $data->type === 'mouse' ? 'selected' : '' }}>Mouse</option>
                                <option value="lainnya" {{ $data->type === 'keyboard' ? 'selected' : '' }}>Keyboard
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="kategori" name="kategori">
                                ...
                                <option value="razer" {{ $data->kategory === 'razer' ? 'selected' : '' }}>Razer</option>
                                <option value="logitech" {{ $data->kategory === 'logitech' ? 'selected' : '' }}>Logitech
                                </option>
                                <option value="lainnya" {{ $data->kategory === 'lainnya' ? 'selected' : '' }}>
                                    Lainnya</option>
                            </select>
                        </div>
                    </div>
