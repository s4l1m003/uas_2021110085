            ...
            <ul class="navbar-nav gap-4">
                <li class="nav-item">
                    <a class="nav-link {{ Request::path() == '/' ? 'active' : '' }}" aria-current="page"
                        href="/" style="color: #000;">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::path() == 'shop' ? 'active' : '' }}" href="/shop" style="color: #000;">Shop</a>
                </li>
                @auth
                    <div class="select" tabindex="0" role="button">
                        ...
                        <div class="links-login" id="links-login">
                            <a href="logout_pelanggan" style="text-decoration: none; color: #000;" role="button"
                                tabindex="0">Keluar</a>
                        </div>
                    </div>
                @else
                ...
                <li class="nav-item">
                    <div class="notif">
                        <a href="/transaksi" class="fs-5 nav-link {{ Request::path() == 'transaksi' ? 'active' : '' }}" style="color: #000;">
                ...
                <li class="nav-item">
                    <div class="notif">
                        <a href="/checkOut" class="fs-5 nav-link {{ Request::path() == 'checkOut' ? 'active' : '' }}" style="color: #000;">
